...
class Invoice(Base):
    ...
    external_driver_phone: Mapped[str | None] = mapped_column(String(40), nullable=True)
    goods_source: Mapped[str | None] = mapped_column(String(30), nullable=True)
    source_customer: Mapped[str | None] = mapped_column(String(180), nullable=True)
    source_return_photo: Mapped[str | None] = mapped_column(String(255), nullable=True)
    source_return_received_at: Mapped[datetime | None] = mapped_column(DateTime, nullable=True)
    source_return_received_by: Mapped[str | None] = mapped_column(String(80), nullable=True)
